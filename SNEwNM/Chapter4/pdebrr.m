% PDEBRR Solve the right preconditionied PDE with brsola.
% This program creates the right preconditionied PDE example
% from Chapter 4
%
%
...
%
x=zeros(n,1); 
[sol, it_histg, ierr] = nsoli(x,'pderight',tol);
%
% BiCGSTAB
%
parms = [40,40,.9,3];
x=zeros(n,1); 
parms=[40,40,-.1];
[sol, it_histg2, ierr] = nsoli(x,'pderight',tol,parms);
%
% Broyden's Method
%
x=zeros(n,1); 
[sol, it_histb, ierr] = brsola(x,'pderight',tol);
figure(1)
