...
maxN = 3e4;     theta = 0.5;      maxIt = 10;      gflag = 1;    
global epsilon
epsilon = 1e-4;
...
% pde = jumpmgdata1; % (-1,1)^3 vs (0, 1)^3
pde = jumpmgdata2;
