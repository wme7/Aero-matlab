function err = getHdiverrorRT0(node,elem,divSigma,sigmah,markedElem)
...
% whose component is the line integral of flux in norm direction, i.e. 
% sigmah_i = \int_{e_i} sigma\cdot n.
%
% err = getHdiverrorRT0(node,elem,divSigma,sigmah)
%
% Example
%     maxIt = 5;
...
%         err(i) = getHdiverrorRT0(node,elem,pde.f,-sigma,[]);
%         N(i) = size(u,1);
%     end
%     r1 = showrate(N,err,2);
...
%
% Created by Ming Wang at Jan 17, 2011, M-lint modified at May 14, 2011.
%
