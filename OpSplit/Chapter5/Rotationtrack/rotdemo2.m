%% Rotation Demonstration: Continous Data
%
...
%
% where the initial function u0 is continuous. To solve the equation, we
...
for i=1:6,
   ...
   caxis([0 1]), title(['CFL = ', num2str(nu)]);
   set(gca,'XTick',[],'YTick',[])
