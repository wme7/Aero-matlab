...
switch method
    ...
    case{1} % TVD 0(h^2)
        ...
        for tsteps = time
            ...
            if plot_figs == 1
            figure(2)
            subplot(2,3,1); plot(x,n(1,:),'o'); axis tight; title('Density')
            subplot(2,3,2); plot(x,p(1,:),'o'); axis tight; title('Pressure')
            subplot(2,3,3); plot(x,t(1,:),'o'); axis tight; title('Temperature')
            subplot(2,3,4); plot(x,r(1,:),'o'); axis tight; title('Fugacity')
            subplot(2,3,5); plot(x,ux(1,:),'o'); axis tight; title('velocity in x')
