function SBBGK_1d_Elimit_func(name,CFL,r_time,theta,quad,method,IC_case, ...
        plot_figs,write_ans,P_deg,~,RK_stages,fmodel,nx)
%% 1D Semi-classical Boltzmann-BGK Equation
% Numerical Evaluation of the Euler Limite using Semiclassical Boltzmann
% Equation. Coded by Manuel Diaz 2012.10.06 
%
...
%     name	='SBBGK_EL_1d'; % Simulation Name
